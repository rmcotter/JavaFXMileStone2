...
/**
 * Main class that runs the GUI as well as actions to perform on the GUI
 * @author Richard Cotter, Kyle Berkow, Soham Amin, Oliver Kao
 *
 */
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		try {
			...
			////////// Creating the top menu of the GUI ///////////
			
			FoodData foodlist = new FoodData(); // Instantiate Foodata
			...
			////////// Rule Creator section of the GUI ////////////
			...
			////////// Filtered Food list section of the GUI ////////////////
			...
			//////////// All of the button actions for the GUI /////////////////
			
			// Adding rule for names
			...
			// Adding a rule for nutrient comparator
			...
			// Clearing a rule, updates the filtered food list
			...
			// Applies rules to the filtered food list
			...
			// Loads data from file, configures pop-up
			...
			// Option for adding a single food item
			...
			// Show the nutrients when selecting food item
